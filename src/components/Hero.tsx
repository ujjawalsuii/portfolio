  ...
  <section className="alpine-hero" id="home" aria-labelledby="hero-title">
    <div className="hero-scene">
      <div className="alpine-photo" aria-hidden="true">
        <picture>
          <source media="(max-width: 640px)" srcSet={`${import.meta.env.BASE_URL}alpine-original.webp`} />
      ...
      <div className="hero-scene-content section-shell">
        ...
        <div className="hero-scene-footer">
          <p>Fourth-year Computing Science at the University of Alberta.<br /><span>Building high-performance systems with elite discipline.</span></p>
